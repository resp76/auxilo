# Relay authentication setup

Relay uses Supabase Auth for Google OAuth, passwordless email links, and email/password accounts.
...
3. In Supabase URL Configuration, set the Site URL to the deployed Relay URL and allow `http://localhost:3000` as a redirect URL for development.
